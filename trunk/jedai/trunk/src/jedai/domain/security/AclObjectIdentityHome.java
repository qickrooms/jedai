...
public class AclObjectIdentityHome {
	...
	private static final Log log = LogFactory
			.getLog(AclObjectIdentityHome.class);
	...
	public AclObjectIdentity merge(AclObjectIdentity detachedInstance) {
		...
		try {
			AclObjectIdentity result = (AclObjectIdentity) sessionFactory
	...
	public AclObjectIdentity findById(java.lang.Long id) {
		...
		try {
			AclObjectIdentity instance = (AclObjectIdentity) sessionFactory
					.getCurrentSession().get(
							"jedai.domain.security.AclObjectIdentity", id);
			if (instance == null) {
	...
	public List findByExample(AclObjectIdentity instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria(
					"jedai.domain.security.AclObjectIdentity").add(
